...
public class CarRendering extends Circle {
	   /**id*/
	   int no;
		...
		public static Color crashedColor = Color.BLACK;
		...
		*/
		public CarRendering(double centerX, double centerY, double radius) {
	   ...
	   */
	   public CarRendering(double centerX, double centerY, double radius, int no) {
	      this(centerX, centerY, radius);
	      this.no = no;
	   }
	   
	   public void crashed() {
		   setFill(crashedColor);
	   }
